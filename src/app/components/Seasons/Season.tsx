...
function Seasons({ seasons }: { seasons: TvTypes }) {
  return (
    <div className="mt-9">
      <h1 className="text-2xl font-bold text-white">Seasons:</h1>
      <h1 className="text-2xl font-bold text-white mb-4">
        Total Episodes: {seasons.number_of_episodes}
      </h1>
      <div className="flex overflow-auto max-w-[900px] gap-4">
        {seasons.seasons.map((season) => (
          <div
            key={season.id}
            className="bg-blue min-w-[230px] rounded-lg p-2 mb-4"
          >
            ...
            <h2 className="text-xl font-bold text-white mt-4">{season.name}</h2>
