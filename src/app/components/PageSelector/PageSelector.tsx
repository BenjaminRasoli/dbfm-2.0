...
function PageSelector({
  ...
  const renderButton = ({
    ...
    <button
      ...
      disabled={isDisabled}
      className={clsx(
        "px-2 lg:px-6 py-1 lg:py-3 bg-blue text-white font-semibold rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:bg-blue-hover ring-2 ring-white ring-opacity-50", 
        {
