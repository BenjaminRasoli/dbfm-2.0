...
function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen">
      <div className="p-3 pt-10 w-[380px] sm:max-w-[500px] md:max-w-[600px] custom-lg:max-w-[900px] 2xl:max-w-[1100px] mx-auto rounded-lg flex flex-col items-center lg:flex-row lg:items-start">
        <Image
          src={
            actor.profile_path
